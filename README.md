...
Flix (I named my project Flixster) is an app that allows users to browse movies from the [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
### App Walkthrough GIF
<img src="https://imgur.com/a/L0xs0X8.gif" width=250><br>
